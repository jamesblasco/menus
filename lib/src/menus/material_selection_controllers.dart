...
class _ContextMenuState extends State<_ContextMenu>
  ...
  Widget _getItem(Widget child, bool isFirst, bool isLast) {
    ...
    return DefaultContextMenuItemTheme(
      data: MaterialTextSelectionToolbarItemBuilder(
...
class MaterialTextSelectionToolbarItemBuilder extends ContextMenuItemThemeData {
  final bool isFirst;
  final bool isLast;
...
class MaterialSelectionToolbar extends RawContextMenu {
